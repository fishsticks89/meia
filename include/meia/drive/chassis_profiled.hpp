            ...
            class MovementInfo {
                public:
                    MovementInfo(move_type_e type = none, Curve start_curve = Curve(0), Curve end_curve = Curve(0), double max_speed = 0, double distance = 0, int id = 0, int delay_time = 100)
                        ...
                        console.log("dif:");
                        console.log(std::ceil((distance - (start_curve_distance + end_curve_distance)) / (max_speed * delay_time / 1000)) - (distance - (start_curve_distance + end_curve_distance)) / (max_speed * delay_time / 1000));
